...
func (h *SettingHandler) GetSettings(c *gin.Context) {
	...
	payload := dto.SystemSettings{
		...
		TokenRefreshScheduledEnabled:            settings.TokenRefreshScheduledEnabled,
		TokenRefreshScheduledMinIntervalMinutes: settings.TokenRefreshScheduledMinIntervalMinutes,
		TokenRefreshScheduledMaxIntervalMinutes: settings.TokenRefreshScheduledMaxIntervalMinutes,
...
func (h *SettingHandler) UpdateSettings(c *gin.Context) {
	...
	settings := &service.SystemSettings{
		...
		TokenRefreshScheduledEnabled: func() bool {
			if req.TokenRefreshScheduledEnabled != nil {
				return *req.TokenRefreshScheduledEnabled
			}
			return previousSettings.TokenRefreshScheduledEnabled
		}(),
		TokenRefreshScheduledMinIntervalMinutes: func() int {
			if req.TokenRefreshScheduledMinIntervalMinutes != nil {
				return *req.TokenRefreshScheduledMinIntervalMinutes
			}
			return previousSettings.TokenRefreshScheduledMinIntervalMinutes
		}(),
		TokenRefreshScheduledMaxIntervalMinutes: func() int {
			if req.TokenRefreshScheduledMaxIntervalMinutes != nil {
				return *req.TokenRefreshScheduledMaxIntervalMinutes
			}
			return previousSettings.TokenRefreshScheduledMaxIntervalMinutes
		}(),
	...
	payload := dto.SystemSettings{
		...
		TokenRefreshScheduledEnabled:            updatedSettings.TokenRefreshScheduledEnabled,
		TokenRefreshScheduledMinIntervalMinutes: updatedSettings.TokenRefreshScheduledMinIntervalMinutes,
		TokenRefreshScheduledMaxIntervalMinutes: updatedSettings.TokenRefreshScheduledMaxIntervalMinutes,
...
func diffSettings(before *service.SystemSettings, after *service.SystemSettings, beforeAuthSourceDefaults *service.AuthSourceDefaultSettings, afterAuthSourceDefaults *service.AuthSourceDefaultSettings, req UpdateSettingsRequest) []string {
	...
	if before.TokenRefreshScheduledEnabled != after.TokenRefreshScheduledEnabled {
		changed = append(changed, "token_refresh_scheduled_enabled")
	}
	if before.TokenRefreshScheduledMinIntervalMinutes != after.TokenRefreshScheduledMinIntervalMinutes {
		changed = append(changed, "token_refresh_scheduled_min_interval_minutes")
	}
	if before.TokenRefreshScheduledMaxIntervalMinutes != after.TokenRefreshScheduledMaxIntervalMinutes {
		changed = append(changed, "token_refresh_scheduled_max_interval_minutes")
	}
