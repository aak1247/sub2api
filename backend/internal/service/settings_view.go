...
type SystemSettings struct {
	...
	TokenRefreshScheduledEnabled            bool
	TokenRefreshScheduledMinIntervalMinutes int
	TokenRefreshScheduledMaxIntervalMinutes int
	...
	// Account expiry auto-pause feature
