...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	accountRepository := repository.NewAccountRepository(client, db, schedulerCache, settingRepository)
	...
	crsSyncService := service.ProvideCRSSyncService(accountRepository, proxyRepository, oAuthService, openAIOAuthService, geminiOAuthService, configConfig, oAuthRefreshAPI)
	accountHandler := admin.ProvideAccountHandler(adminService, oAuthService, openAIOAuthService, geminiOAuthService, antigravityOAuthService, rateLimitService, accountUsageService, accountTestService, concurrencyService, crsSyncService, sessionLimitCache, rpmCache, compositeTokenCacheInvalidator, oAuthRefreshAPI)
	...
	openAIOAuthHandler := admin.ProvideOpenAIOAuthHandler(openAIOAuthService, adminService, oAuthRefreshAPI, compositeTokenCacheInvalidator)
	...
	accountExpiryService := service.ProvideAccountExpiryService(accountRepository, settingService)
