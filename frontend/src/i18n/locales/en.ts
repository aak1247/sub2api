export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      dataImportOverwriteButton: 'Overwrite Import',
      dataImportCoexistButton: 'Import Alongside',
      dataImportDuplicateHint: 'Duplicate accounts already exist. Choose overwrite to update matching accounts, or import alongside to create additional accounts with the same names.',
      dataSearching: 'Searching...',
      dataSearchButton: 'Search by JSON',
      dataSearchResult: 'Search Result',
      dataSearchAccounts: 'Matched Existing Accounts',
      duplicateCheck: 'Detect Duplicate Accounts',
      duplicateChecking: 'Checking...',
      duplicateCheckFound: 'Found {count} duplicate accounts in {groups} groups',
      duplicateCheckNone: 'No duplicate accounts found',
      duplicateCheckFailed: 'Failed to detect duplicate accounts',
      duplicateAccountGroups: 'Duplicate Account Groups',
      duplicateAccountReason: 'Duplicate field: {reason}, {count} accounts',
      duplicateSelectLater: 'Select Later Added',
      duplicateSelectedLater: 'Selected {count} later-added duplicate accounts',
      dataSearchErrors: 'Search Issues',
      dataSearchResultSummary: 'Valid JSON accounts {account_candidates}, matched existing accounts {account_matched}, invalid accounts {account_failed}',
      dataSearchActiveFilter: 'JSON filter active: valid accounts {account_candidates}, showing {account_matched} matched accounts, invalid accounts {account_failed}',
      dataSearchStatusSummary: 'Active {active}, rate limited {rate_limited}, error {error}, token refresh failed {refreshed}, inactive {inactive}, temp unschedulable {temp_unschedulable}',
      dataSearchClearFilter: 'Clear JSON Filter',
      dataSearchSuccess: 'Search completed: {account_matched} existing accounts matched',
      dataSearchCompletedWithErrors: 'Search completed with issues: invalid accounts {account_failed}, matched existing accounts {account_matched}',
      ...
      status: {
        ...
        inactive: 'Inactive',
        error: 'Error',
        refreshed: 'Token Refresh Failed',
        cooldown: 'Cooldown',
        paused: 'Paused',
        limited: 'Limited',
      ...
      bulkActions: {
        ...
        selectAllFiltered: 'Select all matching ({count})',
        selectingFiltered: 'Selecting...',
        selectAllFilteredSuccess: 'Selected {count} matching account(s)',
        selectAllFilteredFailed: 'Failed to select matching accounts',
    ...
    settings: {
      ...
      features: {
        ...
        accountExpiryAutoPause: {
          title: 'Account Expiry Auto Pause',
          description: 'Controls whether the system automatically pauses scheduling after accounts expire. Enabled by default.',
          enabled: 'Enable Account Expiry Auto Pause',
          enabledHint: 'When off, accounts are not automatically paused or filtered by expiration even if their per-account auto-pause option is enabled.',
        },
        riskControl: {
          title: 'Risk Control',
