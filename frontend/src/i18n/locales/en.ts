export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      dataImportOverwriteHint: 'Duplicate accounts already exist. Overwrite import will update matching accounts with the JSON data.',
      ...
      dataSearchStatusSummary: 'Active {active}, rate limited {rate_limited}, error {error}, inactive {inactive}, temp unschedulable {temp_unschedulable}',
