export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      dataImportOverwriteHint: '检测到已存在的重复账号，覆盖导入会用 JSON 数据更新匹配账号。',
      dataSearching: '搜索中...',
      ...
      dataSearchStatusSummary: '正常 {active}，限流中 {rate_limited}，错误 {error}，停用 {inactive}，临时不可调度 {temp_unschedulable}',
