export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      dataImportOverwriteButton: '覆盖导入',
      dataImportCoexistButton: '并存导入',
      dataImportDuplicateHint: '检测到已存在的重复账号。覆盖导入会更新匹配账号，并存导入会创建同名新账号。',
      dataSearching: '搜索中...',
      dataSearchButton: '按 JSON 搜索',
      dataSearchResult: '搜索结果',
      dataSearchAccounts: '命中的现有账号',
      duplicateCheck: '重复账号检测',
      duplicateChecking: '检测中...',
      duplicateCheckFound: '检测到 {count} 个重复账号，分布在 {groups} 组',
      duplicateCheckNone: '未检测到重复账号',
      duplicateCheckFailed: '重复账号检测失败',
      duplicateAccountGroups: '重复账号组',
      duplicateAccountReason: '重复字段：{reason}，账号 {count} 个',
      duplicateSelectLater: '选择较晚添加',
      duplicateSelectedLater: '已选择 {count} 个较晚添加的重复账号',
      dataSearchErrors: '搜索问题',
      dataSearchResultSummary: 'JSON 有效账号 {account_candidates}，命中现有账号 {account_matched}，无效账号 {account_failed}',
      dataSearchActiveFilter: 'JSON 筛选中：有效账号 {account_candidates}，当前显示 {account_matched} 个命中账号，无效账号 {account_failed}',
      dataSearchStatusSummary: '正常 {active}，限流中 {rate_limited}，错误 {error}，Token 刷新失败 {refreshed}，停用 {inactive}，临时不可调度 {temp_unschedulable}',
      dataSearchClearFilter: '清除 JSON 筛选',
      dataSearchSuccess: '搜索完成：命中现有账号 {account_matched}',
      dataSearchCompletedWithErrors: '搜索完成但有问题：无效账号 {account_failed}，命中现有账号 {account_matched}',
      ...
      bulkActions: {
        ...
        selectAllFiltered: '选择全部匹配账号（{count}）',
        selectingFiltered: '选择中...',
        selectAllFilteredSuccess: '已选择 {count} 个匹配账号',
        selectAllFilteredFailed: '选择匹配账号失败',
        clear: '清除选择',
        edit: '批量编辑账号',
        delete: '批量删除',
    ...
    settings: {
      ...
      features: {
        ...
        accountExpiryAutoPause: {
          title: '账号过期自动暂停',
          description: '控制账号到期后是否由系统自动暂停调度。默认开启。',
          enabled: '启用账号过期自动暂停',
          enabledHint: '关闭后，即使单个账号开启“过期自动暂停调度”，系统也不会因过期自动暂停或过滤该账号。',
        },
        riskControl: {
          title: '风控中心',
